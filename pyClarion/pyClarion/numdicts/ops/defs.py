...
class IsClose[D: "nd.NumDict"](OpBase[D]):
    def __call__(self, d1: D, d2: D, /, by: KeyForm | None = None, rel_tol: float = 1e-9,
                 abs_tol: float = 0) -> D:
    ...
    def grad(self, g: D, r: D, d1: D, d2: D, /, by: KeyForm | None = None, rel_tol: float = 1e-9,
             abs_tol: float = 0) -> tuple[D, D]:
