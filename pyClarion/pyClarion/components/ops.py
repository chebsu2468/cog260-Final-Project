...
class Cost(OpBase[NumDict]):
    ...
    def __call__(self, est: NumDict, tgt: NumDict, msk: NumDict, /,
                 by: KeyForm | tuple[KeyForm, KeyForm] | None = None) -> NumDict:
    ...
    def grad(self, g: NumDict, r: NumDict, est: NumDict, tgt: NumDict, msk: NumDict, /,
             by: KeyForm | tuple[KeyForm, KeyForm] | None = None) -> tuple[
        NumDict, NumDict, NumDict]:
